...
osascript -e 'display dialog "Package installation in progress" buttons {"Installer"} default button 1'
...
sudo defaults write /Library/LaunchDaemons/removeAdmin.plist StartInterval -integer 720
